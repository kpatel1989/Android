...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = getContentResolver().query(NotesProvider.CONTENT_URI,Database.ALL_COLUMNS,null,null,null);
    ...
    public void insertNote(String note) {
        ...
        NotesProvider provider = new NotesProvider();
        Uri uri = provider.insert(NotesProvider.CONTENT_URI,values);
        Log.d("Note inserted", uri.getLastPathSegment());
    }
